...
CREATE TABLE "star_to_star_system" ("star_id" INTEGER NOT NULL, "star_system_id" INTEGER NOT NULL,
                                    PRIMARY KEY ("star_id", "star_system_id")
                                    FOREIGN KEY (star_id) REFERENCES star (id),
                                    FOREIGN KEY (star_system_id) REFERENCES star_system (id));

DROP TABLE IF EXISTS "configuration";
CREATE TABLE "configuration" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE,
                              "star_system1_id" INTEGER NOT NULL, "star_system2_id" INTEGER NOT NULL,
                              "separation" FLOAT, "separation_error" FLOAT, "separation_ref_id" INTEGER,
                              "period" FLOAT, "period_error" FLOAT, "spec_ref_id" INTEGER,
                              "K1" FLOAT, "K1_error" FLOAT, "K2" FLOAT, "K2_error" FLOAT,
                              FOREIGN KEY (star_system1_id) REFERENCES star_system (id),
                              FOREIGN KEY (star_system2_id) REFERENCES star_system (id),
